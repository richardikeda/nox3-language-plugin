...
public class NOX3ValueImpl extends ASTWrapperPsiElement implements NOX3Value {

  public NOX3ValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public NOX3Expression getExpression() {
    return findNotNullChildByClass(NOX3Expression.class);
  }
